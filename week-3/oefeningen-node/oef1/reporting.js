...
function showConfusingStatistics(highImportanceCount, lowImportanceCount, data) {
...
function showComplexOperations(highComplexityCount, lowComplexityCount, data) {
...
module.exports = {
  showDataFormatting,
  showConfusingStatistics,
  showComplexOperations
};
